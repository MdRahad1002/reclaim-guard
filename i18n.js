...
const TRANSLATIONS = {
  en: {
    ...
    hero_form_heading: 'Check if your money is recoverable',
    hero_form_sub: 'It takes about 2 minutes. Free, confidential and no obligation.',
    hero_whatsapp: 'Chat on WhatsApp',
    hero_or: 'or',
    hero_urgency: 'Act fast, the first 72 hours give the best chance of recovery.',
    hero_reassure: '🔒 We never ask for upfront fees to release your money.',
    nextstep_title: 'What happens after you get in touch',
    nextstep_sub: 'No pressure, no obligation, and no upfront fees. Here is exactly what to expect.',
    nextstep_1_title: 'You tell us what happened',
    nextstep_1_text: 'Share a few basics in under 2 minutes, by form or WhatsApp. Free and confidential. We never ask for payment to release your money.',
    nextstep_2_title: 'We review and reply within 24 hours',
    nextstep_2_text: 'A specialist reviews your case and gives you an honest assessment of whether your funds can be traced and recovered. Recovery is never guaranteed.',
    nextstep_3_title: 'You decide, with no obligation',
    nextstep_3_text: 'If we can help and you choose to proceed, it is no win, no fee, you only pay a success fee if we actually recover money. No pressure either way.',
    reviews_title: 'What our clients say',
    reviews_sub: 'Feedback from people we have helped. Individual experiences vary and recovery is never guaranteed.',
    rev1_text: 'I lost £18,500 after being convinced to invest through what appeared to be a legitimate online trading platform. Reclaim Guard reviewed the information I provided and explained the investigation process clearly. The team was professional and kept me informed throughout the process.',
    rev1_tag: 'Lost £18,500 · Fake trading platform',
    rev2_text: 'I contacted Reclaim Guard after losing £7,200 in a cryptocurrency scam. I was unsure where to turn and wanted someone to properly review what had happened. The team took the time to understand my situation and explained the available options clearly.',
    rev2_tag: 'Lost £7,200 · Cryptocurrency scam',
    rev3_text: 'After losing £42,000 through an online investment scam, I contacted Reclaim Guard for guidance. They carefully reviewed the details of my case and helped me understand the next steps. I appreciated the professional communication and the way the process was explained.',
    rev3_tag: 'Lost £42,000 · Online investment scam',
    compare_title: 'A regulated law firm, not a "recovery agent"',
    compare_sub: 'Fraud victims are often targeted a second time. Here is how a genuine, regulated firm differs from the fake "recovery" services that chase you afterwards.',
    compare_good_title: 'ReclaimGuard Legal',
    compare_good_1: 'SRA-regulated law firm (No. 830575), verifiable on the public SRA register',
    compare_good_2: 'Registered UK company (Companies House No. 13438429)',
    compare_good_3: 'Free case review, no win no fee, a success fee only if we recover money',
    compare_good_4: 'We speak with you by phone and give an honest assessment, recovery is never guaranteed',
    compare_good_5: 'We never ask for upfront "release", "tax" or "AML" fees',
    compare_bad_title: 'Fake "recovery agents"',
    compare_bad_1: 'No regulation and no licence you can verify',
    compare_bad_2: 'Demand upfront fees to "release" or "unlock" your funds',
    compare_bad_3: 'Guarantee recovery or promise a fixed amount back',
    compare_bad_4: 'Contact only via chat, Telegram or WhatsApp, with no verifiable identity',
    compare_bad_5: 'Pressure you to pay quickly before you can check them out',
    compare_verify: 'Always verify any firm on the <a href="https://www.sra.org.uk/consumers/register/" target="_blank" rel="noopener">SRA register</a> and <a href="https://find-and-update.company-information.service.gov.uk/company/13438429" target="_blank" rel="noopener">Companies House</a> before sharing details or sending money.',
  ...
  de: {
    ...
    hero_form_heading: 'Prüfen Sie, ob Ihr Geld rückgewinnbar ist',
    hero_form_sub: 'Es dauert etwa 2 Minuten. Kostenlos, vertraulich und unverbindlich.',
    hero_whatsapp: 'Über WhatsApp chatten',
    hero_or: 'oder',
    hero_urgency: 'Handeln Sie schnell, die ersten 72 Stunden bieten die besten Chancen auf Rückgewinnung.',
    hero_reassure: '🔒 Wir verlangen niemals Vorabgebühren, um Ihr Geld freizugeben.',
    nextstep_title: 'Was passiert, nachdem Sie sich gemeldet haben',
    nextstep_sub: 'Kein Druck, keine Verpflichtung und keine Vorabgebühren. Das erwartet Sie genau.',
    nextstep_1_title: 'Sie schildern uns, was passiert ist',
    nextstep_1_text: 'Teilen Sie in unter 2 Minuten ein paar Eckdaten mit, per Formular oder WhatsApp. Kostenlos und vertraulich. Wir verlangen niemals eine Zahlung, um Ihr Geld freizugeben.',
    nextstep_2_title: 'Wir prüfen und antworten innerhalb von 24 Stunden',
    nextstep_2_text: 'Ein Spezialist prüft Ihren Fall und gibt Ihnen eine ehrliche Einschätzung, ob Ihre Gelder verfolgt und zurückgewonnen werden können. Eine Rückgewinnung ist nie garantiert.',
    nextstep_3_title: 'Sie entscheiden, unverbindlich',
    nextstep_3_text: 'Wenn wir helfen können und Sie fortfahren möchten, gilt: kein Erfolg, keine Gebühr. Sie zahlen nur eine Erfolgsgebühr, wenn wir tatsächlich Geld zurückholen. Kein Druck, so oder so.',
    reviews_title: 'Was unsere Mandanten sagen',
    reviews_sub: 'Rückmeldungen von Menschen, denen wir geholfen haben. Individuelle Erfahrungen variieren, und eine Rückgewinnung ist nie garantiert.',
    rev1_text: 'Ich habe 18.500 £ verloren, nachdem ich überzeugt wurde, über eine scheinbar seriöse Online-Trading-Plattform zu investieren. Reclaim Guard prüfte die von mir bereitgestellten Informationen und erklärte den Ermittlungsprozess verständlich. Das Team war professionell und hielt mich während des gesamten Prozesses auf dem Laufenden.',
    rev1_tag: 'Verlust: 18.500 £ · Gefälschte Trading-Plattform',
    rev2_text: 'Ich habe Reclaim Guard kontaktiert, nachdem ich 7.200 £ bei einem Krypto-Betrug verloren hatte. Ich wusste nicht, an wen ich mich wenden sollte, und wollte, dass jemand das Geschehene ordentlich prüft. Das Team nahm sich Zeit, meine Situation zu verstehen, und erklärte die verfügbaren Optionen klar.',
    rev2_tag: 'Verlust: 7.200 £ · Krypto-Betrug',
    rev3_text: 'Nachdem ich 42.000 £ durch einen Online-Anlagebetrug verloren hatte, wandte ich mich für eine Beratung an Reclaim Guard. Sie prüften die Details meines Falls sorgfältig und halfen mir, die nächsten Schritte zu verstehen. Ich schätzte die professionelle Kommunikation und die Art, wie der Prozess erklärt wurde.',
    rev3_tag: 'Verlust: 42.000 £ · Online-Anlagebetrug',
    compare_title: 'Eine regulierte Anwaltskanzlei, kein „Wiederbeschaffungsdienst“',
    compare_sub: 'Betrugsopfer werden oft ein zweites Mal ins Visier genommen. So unterscheidet sich eine echte, regulierte Kanzlei von den gefälschten „Wiederbeschaffungs“-Diensten, die Sie danach verfolgen.',
    compare_good_title: 'ReclaimGuard Legal',
    compare_good_1: 'SRA-regulierte Anwaltskanzlei (Nr. 830575), überprüfbar im öffentlichen SRA-Register',
    compare_good_2: 'Eingetragenes UK-Unternehmen (Companies-House-Nr. 13438429)',
    compare_good_3: 'Kostenlose Fallprüfung, kein Erfolg keine Gebühr, eine Erfolgsgebühr nur, wenn wir Geld zurückholen',
    compare_good_4: 'Wir sprechen mit Ihnen am Telefon und geben eine ehrliche Einschätzung, eine Rückgewinnung ist nie garantiert',
    compare_good_5: 'Wir verlangen niemals Vorabgebühren wie „Freigabe“, „Steuer“ oder „AML“',
    compare_bad_title: 'Gefälschte „Wiederbeschaffungsdienste“',
    compare_bad_1: 'Keine Regulierung und keine überprüfbare Lizenz',
    compare_bad_2: 'Verlangen Vorabgebühren, um Ihre Gelder „freizugeben“ oder „freizuschalten“',
    compare_bad_3: 'Garantieren eine Rückgewinnung oder versprechen einen festen Betrag zurück',
    compare_bad_4: 'Kontakt nur über Chat, Telegram oder WhatsApp, ohne überprüfbare Identität',
    compare_bad_5: 'Drängen Sie zu schneller Zahlung, bevor Sie sie überprüfen können',
    compare_verify: 'Überprüfen Sie jede Kanzlei im <a href="https://www.sra.org.uk/consumers/register/" target="_blank" rel="noopener">SRA-Register</a> und bei <a href="https://find-and-update.company-information.service.gov.uk/company/13438429" target="_blank" rel="noopener">Companies House</a>, bevor Sie Daten teilen oder Geld senden.',
  ...
  "hero_form_heading": "Comprueba si tu dinero es recuperable",
  "hero_form_sub": "Solo toma unos 2 minutos. Gratis, confidencial y sin compromiso.",
  "hero_whatsapp": "Chatear por WhatsApp",
  "hero_or": "o",
  "hero_urgency": "Actúa rápido: las primeras 72 horas ofrecen las mejores probabilidades de recuperación.",
  "hero_reassure": "🔒 Nunca pedimos comisiones por adelantado para liberar tu dinero.",
  "nextstep_title": "Qué ocurre después de contactarnos",
  "nextstep_sub": "Sin presión, sin compromiso y sin comisiones por adelantado. Esto es exactamente lo que puedes esperar.",
  "nextstep_1_title": "Nos cuentas qué pasó",
  "nextstep_1_text": "Comparte unos datos básicos en menos de 2 minutos, por formulario o WhatsApp. Gratis y confidencial. Nunca pedimos un pago para liberar tu dinero.",
  "nextstep_2_title": "Revisamos y respondemos en 24 horas",
  "nextstep_2_text": "Un especialista revisa tu caso y te da una evaluación honesta de si tus fondos se pueden rastrear y recuperar. La recuperación nunca está garantizada.",
  "nextstep_3_title": "Tú decides, sin compromiso",
  "nextstep_3_text": "Si podemos ayudarte y decides seguir adelante, es sin ganar no hay honorarios: solo pagas una comisión de éxito si realmente recuperamos dinero. Sin presión, en cualquier caso.",
  "reviews_title": "Lo que dicen nuestros clientes",
  "reviews_sub": "Opiniones de personas a las que hemos ayudado. Las experiencias individuales varían y la recuperación nunca está garantizada.",
  "rev1_text": "Perdí 18.500 £ tras ser convencido de invertir a través de lo que parecía una plataforma de trading online legítima. Reclaim Guard revisó la información que proporcioné y me explicó el proceso de investigación con claridad. El equipo fue profesional y me mantuvo informado durante todo el proceso.",
  "rev1_tag": "Pérdida: 18.500 £ · Plataforma de trading falsa",
  "rev2_text": "Contacté con Reclaim Guard tras perder 7.200 £ en una estafa de criptomonedas. No sabía a quién acudir y quería que alguien revisara correctamente lo que había pasado. El equipo se tomó el tiempo de entender mi situación y me explicó las opciones disponibles con claridad.",
  "rev2_tag": "Pérdida: 7.200 £ · Estafa de criptomonedas",
  "rev3_text": "Después de perder 42.000 £ en una estafa de inversión online, contacté con Reclaim Guard para orientación. Revisaron cuidadosamente los detalles de mi caso y me ayudaron a entender los siguientes pasos. Agradecí la comunicación profesional y la forma en que se explicó el proceso.",
  "rev3_tag": "Pérdida: 42.000 £ · Estafa de inversión online",
  "compare_title": "Un bufete regulado, no un «agente de recuperación»",
  "compare_sub": "A las víctimas de fraude a menudo las atacan por segunda vez. Así se diferencia un bufete genuino y regulado de los falsos servicios de «recuperación» que te persiguen después.",
  "compare_good_title": "ReclaimGuard Legal",
  "compare_good_1": "Bufete regulado por la SRA (N.º 830575), verificable en el registro público de la SRA",
  "compare_good_2": "Empresa registrada en el Reino Unido (Companies House N.º 13438429)",
  "compare_good_3": "Revisión gratuita, sin ganar no hay honorarios; comisión de éxito solo si recuperamos dinero",
  "compare_good_4": "Hablamos contigo por teléfono y damos una evaluación honesta; la recuperación nunca está garantizada",
  "compare_good_5": "Nunca pedimos comisiones por adelantado como «liberación», «impuestos» o «AML»",
  "compare_bad_title": "Falsos «agentes de recuperación»",
  "compare_bad_1": "Sin regulación y sin licencia que puedas verificar",
  "compare_bad_2": "Exigen comisiones por adelantado para «liberar» o «desbloquear» tus fondos",
  "compare_bad_3": "Garantizan la recuperación o prometen devolver una cantidad fija",
  "compare_bad_4": "Contacto solo por chat, Telegram o WhatsApp, sin identidad verificable",
  "compare_bad_5": "Te presionan para pagar rápido antes de que puedas comprobarlos",
  "compare_verify": "Verifica siempre cualquier firma en el <a href=\"https://www.sra.org.uk/consumers/register/\" target=\"_blank\" rel=\"noopener\">registro de la SRA</a> y en <a href=\"https://find-and-update.company-information.service.gov.uk/company/13438429\" target=\"_blank\" rel=\"noopener\">Companies House</a> antes de compartir datos o enviar dinero.",
